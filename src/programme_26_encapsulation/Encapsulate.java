...
public class Encapsulate {
    //private variables declared these can only be accessed by public methods od class
    ...
    //get method for all to access private variable rollNo
    ...
    public class TestEncapsulation {
       ...
       // system.out.println("prime's rollNo : + obj.geekNa
